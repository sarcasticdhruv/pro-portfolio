...
export default function Terminal({ github, onClose, isFloating = false }: Props) {
  ...
  function runNeofetch(gh: GitHubStats) {
    ...
    const info = [
      ...
      ['Resolution', res],
      ['CPU', 'Intel Core i7-1165G7 (8) @ 4.700GHz'],
      ['GPU', 'Intel Iris Xe Graphics'],
      ['Memory', `3.2GiB / 16384MiB (19%)`],
      ['Disk', '42G / 512G (9%) — btrfs'],
      [''],
      ['GitHub', `${repos} repos · ${stars} stars · ${followers} followers`],
      ['Rank', 'Dept #2 · CGPA 8.94 · MITS Gwalior'],
      ['Role', 'AI Engineer @ Ignited Wings Technology'],
      [''],
      ['colors'],
    ];
