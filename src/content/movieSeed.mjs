...
export const MOVIE_SEED = [
  ...
  { title: 'Grosse Pointe Blank', year: 1997 , rating: 4, tags: ['comfort-watch', 'rewatchable'], blogSlug: 'last-months-watchlist', review: "The one I keep rewatching and can never fully explain why." , favorite: true },
  ...
  { title: 'Crash', year: 2004 , favorite: true },
  ...
  { title: 'Paris, Texas', year: 1984 , rating: 4.5, tags: ['beautiful', 'stayed-with-me'] , favorite: true },
