...
import { IMAGINE_EXAMPLES } from '../content/imagineExamples.mjs';
  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '110px', paddingBottom: '80px' }}>
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '0 clamp(16px, 5vw, 24px)' }}>
        ...
        {/* Prompt ideas - always rendered (not gated behind any interaction
            state), so crawlers and users see the same real, substantive
            content. Same array also feeds scripts/prerender.mjs. */}
        <div style={{ marginTop: '56px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {IMAGINE_EXAMPLES.map(ex => (
              <div key={ex.prompt} style={{
                padding: '14px 16px',
                background: 'var(--surface)', border: '1px solid var(--border)',
                borderRadius: '10px',
              }}>
                <button
                  onClick={() => { setPrompt(ex.prompt); generate(ex.prompt); }}
                  style={{
